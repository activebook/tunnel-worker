#!/usr/bin/env bash
# delete-dist2.sh — Personal script: delete the tunnel-worker on the mydev.ccwu.cc account
...
echo "⚠️  This will permanently delete worker '${WORKER_NAME}' from the mydev.ccwu.cc account."
